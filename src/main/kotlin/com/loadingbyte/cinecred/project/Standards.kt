...
val PRESET_CONTENT_STYLE = ContentStyle(
    ...
    flowCellHGapPx = 32.0,
    flowSeparator = "\u2022",
    flowSeparatorLetterStyleName = Override(null),
    ...
    hasHead = false,
    headLetterStyleName = Override(null),
    ...
    headGapPx = 4.0,
    headLeader = "",
    headLeaderLetterStyleName = Override(null),
    ...
    hasTail = false,
    tailLetterStyleName = Override(null),
    ...
    tailGapPx = 4.0,
    tailLeader = "",
    tailLeaderLetterStyleName = Override(null),
